    ...
    <>
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:grid sm:grid-cols-[1fr_auto_1fr] sm:px-6 sm:py-4">
        ...
        <div className="flex items-center gap-2.5 justify-self-end text-sm">
          <a
            href="/login"
            className="hidden border border-[#d9d5cb] px-3.5 py-1.5 font-medium text-soft transition-colors hover:border-ink hover:text-ink sm:inline-block"
          >
            Sign in
          </a>
          <a
            href="/login"
            className="bg-ink px-3.5 py-1.5 font-medium text-[#f4f2ec] hover:opacity-85 active:translate-y-px"
          >
            Get a key
          </a>
        </div>
...
export function SiteFooter() {
  return (
    <footer className="bg-[#1c1a17] text-[#a8a29e]">
