...
export const ECONOMICS: EconCluster[] = [
  ...
  { id: 'code-review', name: 'Reviewing code', points: [{ q: 0.7514, c: 2.229 }, { q: 0.9, c: 2.5336 }, { q: 0.9548, c: 3.7973 }, { q: 0.7762, c: 4.0773 }, { q: 0.9119, c: 4.2262 }, { q: 0.969, c: 4.5772 }] },
  ...
  { id: 'extraction', name: 'Pulling data out of documents', points: [{ q: 0.9595, c: 0.0237 }, { q: 0.9612, c: 0.2019 }, { q: 0.956, c: 0.286 }, { q: 0.9595, c: 0.3722 }, { q: 0.9841, c: 0.5785 }, { q: 0.9611, c: 1.4358 }, { q: 0.9729, c: 1.4644 }, { q: 0.9778, c: 1.5836 }, { q: 0.9841, c: 1.7698 }, { q: 0.9778, c: 4.0693 }] },
