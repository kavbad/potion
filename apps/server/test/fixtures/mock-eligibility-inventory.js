...
export const MOCK_ELIGIBILITY_INVENTORY = [
    // ---- the systemic root: every provider set carries a mock transport ----
    {
        ...
        notes: 'ALWAYS returns a working mock transport at key `mock`, including in live sets. Safe only because ' +
    ...
    },
    {
        ...
        kind: 'factory',
        mockPosture: 'mode-blind',
        notes: 'alias → price entry → providers[entry.provider]; a mock-provider entry resolves to the mock transport. ' +
    ...
    },
    {
        ...
        regressionTest: 'packages/researcher/src/registry.test.ts',
        notes: 'cheapest-first, so $0 mock entries WIN every class unless excluded — the G1.5 finding. ' +
    ...
    },
    {
        ...
        notes: 'G2.4: a live cycle builds candidates over the reachable() registry only, and refuses when no ' +
    ...
    },
    {
        ...
        kind: 'class-resolution',
        mockPosture: 'mock-allowed-by-design',
        notes: 'the synthesis sweep is hard-coded provider:mock, and the judge alias it stamps into the derived ' +
    ...
    },
    {
        ...
        notes: 'G2.4: a live-RECORDED calibration refuses mock judges AND the mock-cheap default answerer. Pre-G2.4 ' +
    ...
    },
    {
        ...
        notes: 'lets a run STAMP a mode the transports do not have — false-live by construction. No non-test caller ' +
    ...
    // ---- serving path ----
    {
        ...
        notes: 'G2.4 (fifth false-live instance, FIRST on the serving path): the mock-alias DEFAULT_STRATEGY is the ' +
    ...
    },
    {
        ...
        notes: "G2.4: 'mock' is no longer an accepted BYOK provider id. Pre-G2.4 a customer could register a mock key, " +
    ...
    },
    {
        ...
        notes: "resolves guarantee.judgeModel ?? defaultServeJudgeModel(ctx.providerMode) — under live that is a real " +
    ...
    },
    {
        ...
        mockPosture: 'refuses-live',
        regressionTest: 'packages/harness/src/calibrate.test.ts',
        notes: 'G2.4: threads --provider into runJudgeCalibration as providerMode, so a live-recorded calibration ' +
    ...
    // ---- provenance of recorded evidence ----
    {
        ...
        mockPosture: 'excluded-live',
        regressionTest: 'packages/workers/src/false-live.test.ts',
        notes: 'G2.4: mock/* listings keep provider mock. Pre-G2.4 every scanned listing was stamped openrouter, so the ' +
...
//# sourceMappingURL=mock-eligibility-inventory.js.map