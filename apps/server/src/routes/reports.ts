...
// The verified-savings primitives moved to ../verified-savings.ts (the
// invoice bills from them too — one implementation); re-exported here so
// every existing import keeps working.
import { VERIFIED_OFF, buildVerifiedSavings, type VerifiedSavings } from '../verified-savings.js';
export { MIN_HOLDOUT_REQUESTS, VERIFIED_OFF, buildVerifiedSavings, type VerifiedSavings } from '../verified-savings.js';
