// Instrument campaign — extraction-hard-v2 validation leg (2026-08-26).
// Pre-registered (tasks/todo.md): the 16-item messy tier joins hard-v1's
// 24; this leg takes fresh salted baselines of the extraction pool on the
// NEW suite. Success = the messy tier discriminates (splits on exh2-m*;
// top pooled < 0.99 or measurable top-3 spread) and carries no authoring
// defects (nobody-passes = my bug). Failures are published, not buried.
// Adapted from scripts/a3-validation-leg.ts — same machinery, new params.
...
const MODELS = ['or-solar-pro4', 'or-gpt-full', 'or-gemini-flash', 'or-gpt-mini', 'or-sonnet'];
