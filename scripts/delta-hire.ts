...
const answers = {
  ...
  constraints: [
    ...
    'A held cluster’s observed mean may sit below its stored quality (within the margin) or above the interval entirely and still hold — never claim that held clusters scored at or above their stored quality, and never claim they all sat inside their intervals.',
