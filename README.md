...
Any OpenAI SDK works unchanged: set `baseURL` to `https://api.withpotion.com/v1`
and the API key to a Potion key. Keys, policies, usage, and receipts are managed
in the dashboard at `app.withpotion.com`.
