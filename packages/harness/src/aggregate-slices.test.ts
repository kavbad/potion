...
const cell = (itemId: string, quality: number): EvalResult => ({
  ...
  quality, scorer: 'exact', usage: { inputTokens: 100, outputTokens: 10, costUsd: 0.001, latencyMs: 100 },
  // latencyMs at the CELL is required on the trunk's EvalResult; the capture
  // predates that field being mandatory.
  latencyMs: { p50: 100, p95: 100, mean: 100 }, modelVersions: {}, pricesVersion: 'p', createdAt: 't',
});
const cells = [
